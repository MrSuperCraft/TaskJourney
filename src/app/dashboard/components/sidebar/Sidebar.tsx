...
const Sidebar: React.FC = () => {
  ...
  function CloseSidebarButton() {
    return (
      <Tooltip content="Close Sidebar" color="foreground" placement="bottom">
        <Button
          isIconOnly
          className="bg-primary-50 rounded-full text-primary-500 dark:text-dark-primary-brand dark:bg-gray-700"
  ...
  function GetAssistanceButton() {
    return (
      ...
      >
        <Button
          isIconOnly
          className="bg-slate-100/50 rounded-full text-slate-100 dark:bg-gray-700"
          onClick={() => handleTabClick("ai-assistance")}
          aria-label="Get AI Assistance"
        >
          <FaRegComment className="text-[#BABABA] dark:text-primary-brand-600 text-base" />
        </Button>
      </Tooltip>
    );
  }
  ...
  function ProfileSection({
    ...
    const LONG_USERNAME_CHARACTERS = 12;

    if (username.length >= LONG_USERNAME_CHARACTERS) {
      return (
        ...
        <div className="flex flex-col items-center">
          {profilePicture ? (
            <Image
              src={profilePicture}
              alt="Profile"
              className="w-20 h-20 mr-3 border rounded-full object-cover" 
              width={80}
              height={80}
              unoptimized 
            />
    ...
    <>
      ...
      >
        <div className="bg-white dark:bg-gray-900 text-gray-800 dark:text-white w-64 flex flex-col items-center justify-between min-h-full shadow-lg">
          ...
          {/* Branding */}
          <div className="py-4 text-2xl font-bold text-primary-500 dark:text-primary-brand-600 flex items-center justify-center">
...
{/*             TaskJourney */}
          ...
          <div className="flex flex-col mt-4 w-full">
            ...
            <TabButton
              ...
              label="AI Assistance"
              onClick={() => handleTabClick("AI-Assistance")}
              isLoading={loadingTab === "ai-assistance"}
            />
            <TabButton
              icon={
                <FaCalendarAlt />
            ...
            <TabButton
              ...
              isLoading={loadingTab === "calendar"}
            />
            <Switch color="success" isSelected={theme === "dark"} onValueChange={toggleTheme} aria-label="Automatic updates">
                Change Theme
            </Switch>
