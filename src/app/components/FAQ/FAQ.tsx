        ...
        <div className="w-full h-min-screen bg-slate-300 dark:bg-dark-teal">
            <div className="max-w-3xl mx-auto p-10">
                ...
                <Accordion variant='shadow'>
                    <AccordionItem
                        title={<span className="font-bold flex items-center max-sm:text-md"><FaQuestionCircle className="mr-4 text-xl max-sm:hidden" /> What is TaskJourney and how does it help users improve productivity?</span>}
                    ...
                    <AccordionItem
                        title={<span className="font-bold flex items-center max-sm:text-md"><FaRobot className="mr-4 text-xl max-sm:hidden" /> How does the AI assistant in TaskJourney help users with goal planning and prioritization?</span>}
                    ...
                    <AccordionItem
                        title={<span className="font-bold flex items-center max-sm:text-md"><FaGamepad className="mr-4 text-xl max-sm:hidden" /> What gamification elements does TaskJourney offer to motivate users and enhance their productivity?</span>}
                    ...
                    <AccordionItem
                        title={<span className="font-bold flex items-center max-sm:text-md"><FaBell className="mr-4 text-xl max-sm:hidden" /> How do notifications work in TaskJourney, and can users customize their notification preferences?</span>}
                    ...
                    <AccordionItem
                        title={<span className="font-bold flex items-center max-sm:text-md"><FaLock className="mr-4 text-xl max-sm:hidden" /> What security measures are in place to protect user data and ensure privacy on TaskJourney?</span>}
