    ...
    return (
        ...
        <div className="relative w-full h-screen flex flex-col justify-center items-center">
            ...
            <motion.div
                ...
                className="container mx-auto text-center relative z-10 text-black flex flex-col justify-center items-center lg:flex-row lg:items-center lg:justify-center lg:space-x-8"
            >
                <motion.div
